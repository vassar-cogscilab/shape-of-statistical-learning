...
parameters { // define parameters (and their bounds) used in the model
  ...
  vector<lower=0>[k] NU; // affects near which asymptote maximum growth occurs
  vector<lower=0>[k] C; // affects upper asymptote (lower for us)
  vector<lower=0>[k] Q; // related to inital value of mu_l
